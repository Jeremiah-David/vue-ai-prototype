                    ...
                    <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 min-h-96">
                        ...
                        <div v-if="storyElements.length > 0" class="mb-8">
                            <div v-for="element in storyElements" :key="element.id"
                                ...
                                <h4 v-if="element.storyType === 'title'" class="text-xl font-bold text-white">
                                    {{ element.content }}
                                </h4>
                                <p v-else-if="
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                            ...
                            <div v-for="element in elements" :key="element.id"
                                ...
                                <!-- Dynamic Cards -->
                                <div v-else-if="element.type === 'card'" :class="getCardClasses(element)"
...
<script setup>
    ...
    const processCommand = async () => {
        ...
        try {
            // Process command with AI service using the manipulation registry
