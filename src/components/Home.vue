<template>
    ...
    >
        ...
        <!-- Hero Section -->
        <section
            class="relative flex items-center justify-center min-h-[80vh] px-4"
        >
            <!-- Background Effects -->
            ...
            <div class="relative z-10 text-center max-w-5xl mx-auto">
                ...
                >
                    Transform your applications with intelligent interface
                    control. Add buttons, counters, and components through
                    natural AI commands.
                </p>
                ...
                >
                    ...
                    <div
                        v-if="isProcessing"
                        class="mb-4 p-4 bg-blue-500/20 border border-blue-400/30 rounded-lg"
                    >
                    ...
                    <div v-if="commandHistory.length > 0" class="mb-6">
                        ...
                        <div class="space-y-2 max-h-32 overflow-y-auto">
                            <div
                                v-for="(cmd, index) in commandHistory.slice(-3)"
                                :key="index"
                ...
                <div class="w-full max-w-6xl mx-auto" :style="backgroundStyle">
                    <div
                        class="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 min-h-96"
                    >
                        <h3
                        ...
                        <div v-if="storyElements.length > 0" class="mb-8">
                            ...
                            >
                                ...
                                <div
                                    v-else-if="
                                        element.storyType === 'character'
                                    "
                                    class="flex items-center space-x-3"
                                >
                                    <div
                                        class="w-3 h-3 rounded-full bg-purple-400"
                                    ></div>
                                    <span
                        ...
                        >
                            ...
                            >
                                <button
                                    ...
                                    :class="getButtonClasses(element)"
                                ...
                                <!-- Dynamic Counters -->
                                <div
                                    v-else-if="element.type === 'counter'"
                                    :class="getCounterClasses(element)"
                                ...
                                >
                                    ...
                                    <button
                                        @click="incrementCounter(element.id)"
                                ...
                                >
                                    <div
                                        :class="getImageClasses(element)"
                                        class="w-full h-32 flex items-center justify-center text-white"
                                    >
                                        <span class="text-lg">{{
                                            element.content || '🖼️ Image'
                                        }}</span>
                                    </div>
                                    <div
                                        class="absolute bottom-2 left-2 text-xs text-white/80"
                                    >
                                        {{ element.alt }}
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <p class="text-gray-400">
                                Type a command above to see AI magic happen!
                            </p>
                            <p class="text-sm text-gray-500 mt-2">
                                Try: "Create a magical adventure story" or "Add
                                colorful buttons"
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm">
                    <span
                        class="px-4 py-2 bg-white/10 backdrop-blur-sm text-white rounded-full border border-white/20"
                    >
            ...
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                        Watch as AI commands seamlessly transform your
                        application's interface in real-time
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <p class="text-gray-400">
                            Add buttons, counters, and UI elements through
                            simple AI commands
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p class="text-gray-400">
                            Instant visual feedback as AI manipulates your
                            interface
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p class="text-gray-400">
                            Built with Vue 3 and designed for production
                            environments
                        </p>
                    </div>
                </div>
        ...
        <section id="demo" class="relative py-20 px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div
                    class="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10"
                >
                    <div class="bg-slate-800 rounded-2xl p-6 mb-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-gray-400 text-sm"
                                >AI Command Interface</span
                            >
                        </div>
                        <div class="text-left">
                            <div class="text-green-400 mb-2">
                                $ ai.addButton("Click Me", "primary")
                            </div>
                            <div class="text-blue-400 mb-2">
                                $ ai.incrementCounter("mainCounter")
                            </div>
                            <div class="text-purple-400">
                                $ ai.changeBackground("gradient-purple")
                            </div>
                        </div>
                    </div>
                    <p class="text-gray-300 text-lg">
                        Ready to revolutionize how you build interfaces? Start
                        your journey with AIAlpha.
                    </p>
                </div>
            </div>
        </section>
        ...
        <footer class="relative py-12 px-4 border-t border-white/10">
            <div class="max-w-6xl mx-auto text-center">
                ...
                <p class="text-gray-400 mb-6">
                    Prototype for AI-driven UI manipulation • Built with Vue 3 &
                    Tailwind CSS
                </p>
...
<script setup>
    ...
    // State for AI manipulation (this will be passed to the registry)
    const elements = ref([])
    const storyElements = ref([])
    const counters = reactive({})
    const backgroundStyle = ref('')

    // Create the AI manipulation registry with our UI state
    ...
    // Get the available methods from the registry
    const {
        addButton,
        addCard,
        addCounter,
    ...
    const getButtonClasses = (element) => {
        ...
        return [
            ...baseClasses,
            ...(colorClasses[element.style?.color] || colorClasses.purple),
        ]
    }
    ...
    const handleElementClick = (element) => {
        console.log(
            `Clicked element: ${element.type} - ${element.text || element.title}`
        )
    ...
    const processCommand = async () => {
        ...
        try {
            // Process command with real AI service using the manipulation registry
    ...
    const mockAIProcessor = async (command) => {
        ...
        // Button creation commands
            ...
            const text =
                extractTextFromCommand(cmd, 'button') || 'AI Generated Button'
        ...
        // Counter commands
            ...
            const label =
                extractTextFromCommand(cmd, 'counter') || 'Progress Counter'
        ...
        // Card commands
            ...
            const title =
                extractTextFromCommand(cmd, 'card') || 'AI Generated Card'
    ...
    const runDemoScenario = async (scenario) => {
        ...
        switch (scenario) {
            case 'story':
                currentCommand.value =
                    'Create a magical adventure story with wizards and dragons'
                break
            case 'dashboard':
                currentCommand.value =
                    'Create a corporate dashboard with progress counters and status cards'
                break
            case 'theme':
                currentCommand.value =
                    'Change to a beautiful space theme with starry background'
                break
        }
    ...
    const createPirateStory = async () => {
        ...
        addStoryElement(
            'character',
            'Captain Jack Sparrow - The brave pirate captain'
        )
        await new Promise((resolve) => setTimeout(resolve, 500))

        addStoryElement(
            'paragraph',
            'In the deep blue Caribbean seas, Captain Jack discovered an ancient map leading to the legendary treasure of Captain Blackbeard. The adventure begins with three mysterious keys...'
        )
        await new Promise((resolve) => setTimeout(resolve, 500))
    ...
    const createSpaceStory = async () => {
        ...
        addStoryElement(
            'paragraph',
            'In the year 2150, Commander Nova embarks on humanitys first journey to Alpha Centauri. Armed with advanced technology and unwavering determination, the mission begins...'
        )
        await new Promise((resolve) => setTimeout(resolve, 500))
        ...
        addCard(
            'Mission Status',
            'All systems operational. Crew morale: High. Estimated arrival: 4.3 years.',
            Date.now(),
            { color: 'blue' }
        )
    }
    ...
    const createMagicalStory = async () => {
        ...
        addStoryElement(
            'paragraph',
            'Young apprentices gather at the mystical academy where ancient spells and magical creatures await. Your journey into the world of magic begins with learning three fundamental spells...'
        )
        await new Promise((resolve) => setTimeout(resolve, 500))
        ...
        addCard(
            'Magical Progress',
            'Your magical abilities are growing stronger with each spell you master!',
            Date.now(),
            { color: 'purple' }
        )
    }
    ...
    const createGenericStory = async () => {
        ...
        addStoryElement(
            'paragraph',
            'This is a demonstration of AI-powered storytelling. The system can generate interactive narratives, create themed interfaces, and add dynamic elements based on natural language commands.'
        )
        await new Promise((resolve) => setTimeout(resolve, 500))
    ...
    // Clear demo function using the registry
    const clearDemo = () => {
        manipulationRegistry.clearAllElements()
        commandHistory.value = []
        console.log('Demo cleared via registry')
    }

    // Expose methods for future AI integration and testing
    defineExpose({
        // Registry-based methods (secure AI manipulation)
        manipulationRegistry,
        ...manipulationRegistry.getAvailableMethods(),
        ...
        // Utility functions from registry
        getElementCount,
        getActiveTheme,
        getActionLog,
    })
